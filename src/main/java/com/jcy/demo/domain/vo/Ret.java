...
//    public static Ret failEnum(ResultEnum errorEnum) {
//        return fail("code", errorEnum.getCode()).set("msg", errorEnum.getMessage());
//    }
    ...
    /**************** 以下方法为兼容之前 ResultInfo 返回值 ****************/
    public Integer getCode(){
    	Integer code = (Integer) this.get("code");
    	return code;
    }
    
    public Ret setCode(Integer code){
        this.put("code", code);
        return this;
    }
    ...
    public Ret setInfo(Object info){
        this.put("info", info);
        return this;
    }
     ...
     * ResultInfo.java
     *
     * @param code 2014年11月18日
     */
    public Ret setCodeAndMsg(Integer code) {
        this.put("code", code);
     ...
     * @return
     */
    private static String GetDescByStatus(String status_code) {
